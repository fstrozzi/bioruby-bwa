...
module Bio
  class BWA
      ...
      def self.aln(index_prefix,file_in,params={:n => 0.04,:o => 1,:e => -1,:i => 5, :d => 10,:l => 32,:k => 2,:m => 2000000,:t => 1,:M => 3,:O => 11,:E => 4,:R => 30,:q => 0,:f => nil,:B => nil,:c => false,:L=>false,:N=>false,:I=>false,:b=>false,:single => false,:first => false,:second => false})
          args = ["aln"]
      ...
      ######## Methods to manipulate C arguments and functions ########
